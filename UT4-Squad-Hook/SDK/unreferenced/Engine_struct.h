...
struct FFormatArgumentData {
	...
	int ArgumentValueInt; // 0x30(0x04)
...
struct FMaterialAttributesInput : FExpressionInput {
	int PropertyConnectedBitmask; // 0x0c(0x04)
};
...
struct FTickFunction {
	...
	char bTickEvenWhenPaused : 1; // 0x0c(0x01)
	char bCanEverTick : 1; // 0x0c(0x01)
	char bStartWithTickEnabled : 1; // 0x0c(0x01)
	char bAllowTickOnDedicatedServer : 1; // 0x0c(0x01)
...
struct FPostProcessSettings {
	...
	char bOverride_AmbientOcclusionFadeRadius : 1; // 0x0c(0x01)
	char bOverride_AmbientOcclusionDistance : 1; // 0x0c(0x01)
	...
	char bOverride_AmbientOcclusionMipThreshold : 1; // 0x0d(0x01)
	char pad_D_7 : 1; // 0x0d(0x01)
	...
	char bOverride_RayTracingTranslucencyRefractionRays : 1; // 0x1c(0x01)
	...
	char bOverride_PathTracingSamplesPerPixel : 1; // 0x1d(0x01)
	...
	struct UTexture* AmbientCubemap; // 0x2f0(0x08)
	...
	int DepthOfFieldBladeCount; // 0x308(0x04)
	float AutoExposureBias; // 0x30c(0x04)
	struct UCurveFloat* AutoExposureBiasCurve; // 0x310(0x08)
	float AutoExposureLowPercent; // 0x318(0x04)
	float AutoExposureHighPercent; // 0x31c(0x04)
	float AutoExposureMinBrightness; // 0x320(0x04)
	float AutoExposureMaxBrightness; // 0x324(0x04)
	float AutoExposureSpeedUp; // 0x328(0x04)
	float AutoExposureSpeedDown; // 0x32c(0x04)
	float HistogramLogMin; // 0x330(0x04)
	float HistogramLogMax; // 0x334(0x04)
	float AutoExposureCalibrationConstant; // 0x338(0x04)
	float LensFlareIntensity; // 0x33c(0x04)
	struct FLinearColor LensFlareTint; // 0x340(0x10)
	float LensFlareBokehSize; // 0x350(0x04)
	float LensFlareThreshold; // 0x354(0x04)
	struct UTexture* LensFlareBokehShape; // 0x358(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x360(0x80)
	float VignetteIntensity; // 0x3e0(0x04)
	float GrainJitter; // 0x3e4(0x04)
	float GrainIntensity; // 0x3e8(0x04)
	float AmbientOcclusionIntensity; // 0x3ec(0x04)
	float AmbientOcclusionStaticFraction; // 0x3f0(0x04)
	float AmbientOcclusionRadius; // 0x3f4(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x3f8(0x01)
	char pad_3F8_1 : 7; // 0x3f8(0x01)
	char pad_3F9[0x3]; // 0x3f9(0x03)
	float AmbientOcclusionFadeDistance; // 0x3fc(0x04)
	float AmbientOcclusionFadeRadius; // 0x400(0x04)
	float AmbientOcclusionDistance; // 0x404(0x04)
	float AmbientOcclusionPower; // 0x408(0x04)
	float AmbientOcclusionBias; // 0x40c(0x04)
	float AmbientOcclusionQuality; // 0x410(0x04)
	float AmbientOcclusionMipBlend; // 0x414(0x04)
	float AmbientOcclusionMipScale; // 0x418(0x04)
	float AmbientOcclusionMipThreshold; // 0x41c(0x04)
	char RayTracingAO : 1; // 0x420(0x01)
	char pad_420_1 : 7; // 0x420(0x01)
	char pad_421[0x3]; // 0x421(0x03)
	int RayTracingAOSamplesPerPixel; // 0x424(0x04)
	struct FLinearColor IndirectLightingColor; // 0x428(0x10)
	float IndirectLightingIntensity; // 0x438(0x04)
	char RayTracingGI : 1; // 0x43c(0x01)
	char pad_43C_1 : 7; // 0x43c(0x01)
	char pad_43D[0x3]; // 0x43d(0x03)
	int RayTracingGIMaxBounces; // 0x440(0x04)
	int RayTracingGISamplesPerPixel; // 0x444(0x04)
	float ColorGradingIntensity; // 0x448(0x04)
	char pad_44C[0x4]; // 0x44c(0x04)
	struct UTexture* ColorGradingLUT; // 0x450(0x08)
	float DepthOfFieldSensorWidth; // 0x458(0x04)
	float DepthOfFieldFocalDistance; // 0x45c(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x460(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x464(0x04)
	float DepthOfFieldFocalRegion; // 0x468(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x46c(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x470(0x04)
	float DepthOfFieldScale; // 0x474(0x04)
	float DepthOfFieldNearBlurSize; // 0x478(0x04)
	float DepthOfFieldFarBlurSize; // 0x47c(0x04)
	float DepthOfFieldOcclusion; // 0x480(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x484(0x04)
	float DepthOfFieldVignetteSize; // 0x488(0x04)
	float MotionBlurAmount; // 0x48c(0x04)
	float MotionBlurMax; // 0x490(0x04)
	int MotionBlurTargetFPS; // 0x494(0x04)
	float MotionBlurPerObjectSize; // 0x498(0x04)
	float LPVIntensity; // 0x49c(0x04)
	float LPVVplInjectionBias; // 0x4a0(0x04)
	float LPVSize; // 0x4a4(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x4a8(0x04)
	float LPVSecondaryBounceIntensity; // 0x4ac(0x04)
	float LPVGeometryVolumeBias; // 0x4b0(0x04)
	float LPVEmissiveInjectionIntensity; // 0x4b4(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x4b8(0x04)
	float LPVDirectionalOcclusionRadius; // 0x4bc(0x04)
	float LPVDiffuseOcclusionExponent; // 0x4c0(0x04)
	float LPVSpecularOcclusionExponent; // 0x4c4(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x4c8(0x04)
	float LPVSpecularOcclusionIntensity; // 0x4cc(0x04)
	enum class EReflectionsType ReflectionsType; // 0x4d0(0x01)
	char pad_4D1[0x3]; // 0x4d1(0x03)
	float ScreenSpaceReflectionIntensity; // 0x4d4(0x04)
	float ScreenSpaceReflectionQuality; // 0x4d8(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x4dc(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x4e0(0x04)
	int RayTracingReflectionsMaxBounces; // 0x4e4(0x04)
	int RayTracingReflectionsSamplesPerPixel; // 0x4e8(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x4ec(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x4ed(0x01)
	char pad_4EE[0x2]; // 0x4ee(0x02)
	float RayTracingTranslucencyMaxRoughness; // 0x4f0(0x04)
	int RayTracingTranslucencyRefractionRays; // 0x4f4(0x04)
	int RayTracingTranslucencySamplesPerPixel; // 0x4f8(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x4fc(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x4fd(0x01)
	char pad_4FD_1 : 7; // 0x4fd(0x01)
	char pad_4FE[0x2]; // 0x4fe(0x02)
	int PathTracingMaxBounces; // 0x500(0x04)
	int PathTracingSamplesPerPixel; // 0x504(0x04)
	float LPVFadeRange; // 0x508(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x50c(0x04)
	float ScreenPercentage; // 0x510(0x04)
...
struct FFastArraySerializerItem {
	int ReplicationID; // 0x00(0x04)
	int ReplicationKey; // 0x04(0x04)
	int MostRecentArrayReplicationKey; // 0x08(0x04)
};
...
struct FFastArraySerializer {
	...
	int ArrayReplicationKey; // 0x54(0x04)
...
struct FRealCurve : FIndexedCurve {
	enum class ERichCurveExtrapolation PreInfinityExtrap; // 0x68(0x01)
	enum class ERichCurveExtrapolation PostInfinityExtrap; // 0x69(0x01)
	char pad_6A[0x2]; // 0x6a(0x02)
	float DefaultValue; // 0x6c(0x04)
};
...
struct FActorComponentInstanceData {
	...
	char pad_11[0x3]; // 0x11(0x03)
	int SourceComponentTypeSerializedIndex; // 0x14(0x04)
...
struct FCachedPoseIndices {
	struct TArray<int> OrderedSavedPoseNodeIndices; // 0x00(0x10)
};
...
struct FAnimBlueprintFunction {
	...
	int OutputPoseNodeIndex; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct TArray<struct FName> InputPoseNames; // 0x18(0x10)
	struct TArray<int> InputPoseNodeIndices; // 0x28(0x10)
	struct UStructProperty* OutputPoseNodeProperty; // 0x38(0x08)
	struct TArray<struct UStructProperty*> InputPoseNodeProperties; // 0x40(0x10)
	struct TArray<struct UProperty*> InputProperties; // 0x50(0x10)
...
struct FAnimLinkableElement {
	...
	int SlotIndex; // 0x10(0x04)
	int SegmentIndex; // 0x14(0x04)
...
struct FAnimMontageInstance {
	...
	struct TArray<int> NextSections; // 0xe8(0x10)
	struct TArray<int> PrevSections; // 0xf8(0x10)
	...
	int DisableRootMotionCount; // 0x180(0x04)
	char pad_184[0x24]; // 0x184(0x24)
};
...
struct FAnimNode_CustomProperty : FAnimNode_Base {
	...
	struct TArray<struct UProperty*> SourceProperties; // 0x38(0x10)
	struct TArray<struct UProperty*> DestProperties; // 0x48(0x10)
};
...
struct FAnimNode_Layer : FAnimNode_SubInstance {
	struct UAnimLayerInterface* Interface; // 0x90(0x08)
	struct FName Layer; // 0x98(0x08)
};
...
struct FAnimNode_StateMachine : FAnimNode_Base {
	int StateMachineIndexInClass; // 0x10(0x04)
	int MaxTransitionsPerFrame; // 0x14(0x04)
...
struct FAnimNode_TransitionPoseEvaluator : FAnimNode_Base {
	...
	int FramesToCachePose; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
...
struct FExposedValueHandler {
	...
	struct UStructProperty* ValueHandlerNodeProperty; // 0x20(0x08)
...
struct FExposedValueCopyRecord {
	...
	int SourceArrayIndex; // 0x10(0x04)
	...
	struct UProperty* DestProperty; // 0x18(0x08)
	int DestArrayIndex; // 0x20(0x04)
	int Size; // 0x24(0x04)
	struct UProperty* CachedSourceProperty; // 0x28(0x08)
	struct UProperty* CachedSourceStructSubProperty; // 0x30(0x08)
};
...
struct FAnimationTransitionBetweenStates : FAnimationStateBase {
	int PreviousState; // 0x08(0x04)
	int NextState; // 0x0c(0x04)
	float CrossfadeDuration; // 0x10(0x04)
	int StartNotify; // 0x14(0x04)
	int EndNotify; // 0x18(0x04)
	int InterruptNotify; // 0x1c(0x04)
...
struct FBakedAnimationState {
	...
	int StateRootNodeIndex; // 0x18(0x04)
	int StartNotify; // 0x1c(0x04)
	int EndNotify; // 0x20(0x04)
	int FullyBlendedNotify; // 0x24(0x04)
	bool bIsAConduit; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	int EntryRuleNodeIndex; // 0x2c(0x04)
	struct TArray<int> PlayerNodeIndices; // 0x30(0x10)
	bool bAlwaysResetOnEntry; // 0x40(0x01)
...
struct FBakedStateExitTransition {
	int CanTakeDelegateIndex; // 0x00(0x04)
	int CustomResultNodeIndex; // 0x04(0x04)
	int TransitionIndex; // 0x08(0x04)
	bool bDesiredTransitionReturnValue; // 0x0c(0x01)
	bool bAutomaticRemainingTimeRule; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
	struct TArray<int> PoseEvaluatorLinks; // 0x10(0x10)
};
...
struct FAnimationTransitionRule {
	...
	char pad_9[0x3]; // 0x09(0x03)
	int TransitionIndex; // 0x0c(0x04)
};

// ScriptStruct Engine.TrackToSkeletonMap
// Size: 0x04 (Inherited: 0x00)
struct FTrackToSkeletonMap {
	int BoneTreeIndex; // 0x00(0x04)
};
...
struct FPrimaryAssetRulesCustomOverride {
	...
	struct FPrimaryAssetRules Rules; // 0x28(0x10)
};

// ScriptStruct Engine.PrimaryAssetRules
// Size: 0x10 (Inherited: 0x00)
struct FPrimaryAssetRules {
	int Priority; // 0x00(0x04)
	bool bApplyRecursively; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	int ChunkId; // 0x08(0x04)
...
struct FPrimaryAssetTypeInfo {
	...
	struct UClass* AssetBaseClass; // 0x08(0x28)
...
struct FAtmospherePrecomputeParameters {
	...
	int MaxScatteringOrder; // 0x08(0x04)
	int TransmittanceTexWidth; // 0x0c(0x04)
	int TransmittanceTexHeight; // 0x10(0x04)
	int IrradianceTexWidth; // 0x14(0x04)
	int IrradianceTexHeight; // 0x18(0x04)
	int InscatterAltitudeSampleNum; // 0x1c(0x04)
	int InscatterMuNum; // 0x20(0x04)
	int InscatterMuSNum; // 0x24(0x04)
	int InscatterNuNum; // 0x28(0x04)
};
...
struct FBPVariableDescription {
	...
	uint64 PropertyFlags; // 0x98(0x08)
...
struct FBlueprintCookedComponentInstancingData {
	bool bHasValidCookedData; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<struct FBlueprintComponentChangedPropertyInfo> ChangedPropertyList; // 0x08(0x10)
...
struct FEventGraphFastCallPair {
	...
	int EventGraphCallOffset; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
};
...
struct FGeomSelection {
	int Type; // 0x00(0x04)
	int Index; // 0x04(0x04)
	int SelectionIndex; // 0x08(0x04)
};

// ScriptStruct Engine.BuilderPoly
// Size: 0x20 (Inherited: 0x00)
struct FBuilderPoly {
	struct TArray<int> VertexIndices; // 0x00(0x10)
	int Direction; // 0x10(0x04)
	struct FName ItemName; // 0x14(0x08)
	int PolyFlags; // 0x1c(0x04)
};
...
struct FMinimalViewInfo {
	...
	struct FPostProcessSettings PostProcessSettings; // 0x40(0x530)
	struct FVector2D OffCenterProjectionOffset; // 0x570(0x08)
...
struct FCustomChannelSetup {
	...
	char pad_1[0x3]; // 0x01(0x03)
	struct FName Name; // 0x04(0x08)
	enum class ECollisionResponse DefaultResponse; // 0x0c(0x01)
...
struct FAutoCompleteNode {
	int IndexChar; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TArray<int> AutoCompleteListIndices; // 0x08(0x10)
...
struct FLevelNameAndTime {
	...
	uint32 LevelChangeTimeInMS; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};
...
struct FRawDistributionVector : FRawDistribution {
	float MinValue; // 0x28(0x04)
	float MaxValue; // 0x2c(0x04)
	struct FVector MinValueVec; // 0x30(0x0c)
	struct FVector MaxValueVec; // 0x3c(0x0c)
	struct UDistributionVector* Distribution; // 0x48(0x08)
};
...
struct FEdGraphSchemaAction {
	...
	int Grouping; // 0x68(0x04)
	int SectionID; // 0x6c(0x04)
...
struct FMeshBuildSettings {
	...
	char pad_2[0x2]; // 0x02(0x02)
	int MinLightmapResolution; // 0x04(0x04)
	int SrcLightmapIndex; // 0x08(0x04)
	int DstLightmapIndex; // 0x0c(0x04)
...
struct FAnimUpdateRateParameters {
	...
	char pad_3[0x1]; // 0x03(0x01)
	int UpdateRate; // 0x04(0x04)
	int EvaluationRate; // 0x08(0x04)
	float TickedPoseOffestTime; // 0x0c(0x04)
	float AdditionalTime; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	int BaseNonRenderedUpdateRate; // 0x18(0x04)
	int MaxEvalRateForInterpolation; // 0x1c(0x04)
	struct TArray<float> BaseVisibleDistanceFactorThesholds; // 0x20(0x10)
	struct TMap<int, int> LODToFrameSkipMap; // 0x30(0x50)
	int SkippedUpdateFrames; // 0x80(0x04)
	int SkippedEvalFrames; // 0x84(0x04)
};
...
struct FFontCharacter {
	int StartU; // 0x00(0x04)
	int StartV; // 0x04(0x04)
	int USize; // 0x08(0x04)
	int VSize; // 0x0c(0x04)
	char TextureIndex; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	int VerticalOffset; // 0x14(0x04)
};
...
struct FFontImportOptionsData {
	...
	char pad_75[0x3]; // 0x75(0x03)
	int TexturePageWidth; // 0x78(0x04)
	int TexturePageMaxHeight; // 0x7c(0x04)
	int XPadding; // 0x80(0x04)
	int YPadding; // 0x84(0x04)
	int ExtendBoxTop; // 0x88(0x04)
	int ExtendBoxBottom; // 0x8c(0x04)
	int ExtendBoxRight; // 0x90(0x04)
	int ExtendBoxLeft; // 0x94(0x04)
	char bEnableLegacyMode : 1; // 0x98(0x01)
	char pad_98_1 : 7; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	int Kerning; // 0x9c(0x04)
	char bUseDistanceFieldAlpha : 1; // 0xa0(0x01)
	char pad_A0_1 : 7; // 0xa0(0x01)
	char pad_A1[0x3]; // 0xa1(0x03)
	int DistanceFieldScaleFactor; // 0xa4(0x04)
...
struct FClusterNode {
	...
	int FirstChild; // 0x0c(0x04)
	struct FVector BoundMax; // 0x10(0x0c)
	int LastChild; // 0x1c(0x04)
	int FirstInstance; // 0x20(0x04)
	int LastInstance; // 0x24(0x04)
...
struct FHLODProxyMesh {
	struct ALODActor* LODActor; // 0x00(0x1c)
	char pad_1C[0x4]; // 0x1c(0x04)
...
struct FComponentOverrideRecord {
	...
	struct FBlueprintCookedComponentInstancingData CookedComponentInstancingData; // 0x30(0x50)
};
...
struct FInstancedStaticMeshComponentInstanceData : FSceneComponentInstanceData {
	...
	int InstancingRandomSeed; // 0x120(0x04)
...
struct FCurveEdEntry {
	...
	int bHideCurve; // 0x20(0x04)
	int bColorCurve; // 0x24(0x04)
	int bFloatingPointColorCurve; // 0x28(0x04)
	int bClamp; // 0x2c(0x04)
...
struct FSubTrackGroup {
	...
	struct TArray<int> TrackIndices; // 0x10(0x10)
...
struct FLevelSimplificationDetails {
	...
	char pad_7D[0x3]; // 0x7d(0x03)
	int LandscapeExportLOD; // 0x80(0x04)
...
struct FPrecomputedLightInstanceData : FSceneComponentInstanceData {
	...
	int PreviewShadowMapChannel; // 0xf0(0x04)
...
struct FParameterGroupData {
	struct FString GroupName; // 0x00(0x10)
	int GroupSortPriority; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};
...
struct FScalarParameterAtlasInstanceData {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct UCurveLinearColor* Curve; // 0x08(0x28)
	struct UCurveLinearColorAtlas* Atlas; // 0x30(0x28)
};
...
struct FMeshInstancingSettings {
	...
	int InstanceReplacementThreshold; // 0x08(0x04)
...
struct FMeshMergingSettings {
	...
	char bUseTextureBinning : 1; // 0x89(0x01)
...
struct FMeshProxySettings {
	...
	int LightMapResolution; // 0x8c(0x04)
	...
	char bOverrideVoxelSize : 1; // 0x92(0x01)
	char bOverrideTransferDistance : 1; // 0x92(0x01)
	char bUseHardAngleThreshold : 1; // 0x92(0x01)
	char bComputeLightMapResolution : 1; // 0x92(0x01)
	char bRecalculateNormals : 1; // 0x92(0x01)
	char bUseLandscapeCulling : 1; // 0x92(0x01)
	char bAllowAdjacency : 1; // 0x92(0x01)
	char bAllowDistanceField : 1; // 0x93(0x01)
	char bReuseMeshLightmapUVs : 1; // 0x93(0x01)
	char bCreateCollision : 1; // 0x93(0x01)
	char bAllowVertexColors : 1; // 0x93(0x01)
	char bGenerateLightmapUVs : 1; // 0x93(0x01)
	char pad_93_5 : 3; // 0x93(0x01)
};
...
struct FNavDataConfig : FNavAgentProperties {
	...
	struct FSoftClassPath NavigationDataClassName; // 0x50(0x18)
};
...
struct FNavigationLinkBase {
	...
	char bSnapToCheapestArea : 1; // 0x20(0x01)
	char bCustomFlag0 : 1; // 0x20(0x01)
	char bCustomFlag1 : 1; // 0x20(0x01)
	char bCustomFlag2 : 1; // 0x20(0x01)
	char bCustomFlag3 : 1; // 0x20(0x01)
	char bCustomFlag4 : 1; // 0x20(0x01)
	char bCustomFlag5 : 1; // 0x20(0x01)
	char bCustomFlag6 : 1; // 0x21(0x01)
	char bCustomFlag7 : 1; // 0x21(0x01)
	char pad_21_2 : 6; // 0x21(0x01)
	char pad_22[0x6]; // 0x22(0x06)
	struct UNavAreaBase* AreaClass; // 0x28(0x08)
...
struct FChannelDefinition {
	...
	int StaticChannelIndex; // 0x18(0x04)
...
struct FPacketSimulationSettings {
	int PktLoss; // 0x00(0x04)
	int PktLossMaxSize; // 0x04(0x04)
	int PktLossMinSize; // 0x08(0x04)
	int PktOrder; // 0x0c(0x04)
	int PktDup; // 0x10(0x04)
	int PktLag; // 0x14(0x04)
	int PktLagVariance; // 0x18(0x04)
};
...
struct FParticleRandomSeedInfo {
	...
	char pad_9[0x7]; // 0x09(0x07)
	struct TArray<int> RandomSeeds; // 0x10(0x10)
};
...
struct FParticleEvent_GenerateInfo {
	...
	char pad_1[0x3]; // 0x01(0x03)
	int frequency; // 0x04(0x04)
	int ParticleFrequency; // 0x08(0x04)
...
struct FGPUSpriteEmitterInfo {
	...
	struct FFloatDistribution PointAttractorStrength; // 0xf0(0x28)
	struct FFloatDistribution Resilience; // 0x118(0x28)
	struct FVector ConstantAcceleration; // 0x140(0x0c)
	struct FVector PointAttractorPosition; // 0x14c(0x0c)
	float PointAttractorRadiusSq; // 0x158(0x04)
	struct FVector OrbitOffsetBase; // 0x15c(0x0c)
	struct FVector OrbitOffsetRange; // 0x168(0x0c)
	struct FVector2D InvMaxSize; // 0x174(0x08)
	float InvRotationRateScale; // 0x17c(0x04)
	float MaxLifetime; // 0x180(0x04)
	int MaxParticleCount; // 0x184(0x04)
	enum class EParticleScreenAlignment ScreenAlignment; // 0x188(0x01)
	enum class EParticleAxisLock LockAxisFlag; // 0x189(0x01)
	char pad_18A[0x2]; // 0x18a(0x02)
	char bEnableCollision : 1; // 0x18c(0x01)
	char pad_18C_1 : 7; // 0x18c(0x01)
	char pad_18D[0x3]; // 0x18d(0x03)
	enum class EParticleCollisionMode CollisionMode; // 0x190(0x01)
	char pad_191[0x3]; // 0x191(0x03)
	char bRemoveHMDRoll : 1; // 0x194(0x01)
	char pad_194_1 : 7; // 0x194(0x01)
	char pad_195[0x3]; // 0x195(0x03)
	float MinFacingCameraBlendDistance; // 0x198(0x04)
	float MaxFacingCameraBlendDistance; // 0x19c(0x04)
	struct FRawDistributionVector DynamicColor; // 0x1a0(0x50)
	struct FRawDistributionFloat DynamicAlpha; // 0x1f0(0x38)
	struct FRawDistributionVector DynamicColorScale; // 0x228(0x50)
	struct FRawDistributionFloat DynamicAlphaScale; // 0x278(0x38)
...
struct FPoseDataContainer {
	...
	struct TMap<struct FName, int> TrackMap; // 0x20(0x50)
...
struct FPoseData {
	...
	struct TMap<int, int> TrackToBufferIndex; // 0x10(0x50)
...
struct FPreviewAttachedObjectPair {
	struct UObject* AttachedObject; // 0x00(0x28)
...
struct FPreviewMeshCollectionEntry {
	struct USkeletalMesh* SkeletalMesh; // 0x00(0x28)
};
...
struct FCameraExposureSettings {
	...
	float CalibrationConstant; // 0x30(0x04)
	char pad_34[0x4]; // 0x34(0x04)
};
...
struct FSkeletalMeshLODInfo {
	...
	struct TArray<int> LODMaterialMap; // 0x08(0x10)
	struct FSkeletalMeshOptimizationSettings ReductionSettings; // 0x18(0x3c)
	char pad_54[0x4]; // 0x54(0x04)
	struct TArray<struct FBoneReference> BonesToRemove; // 0x58(0x10)
	struct TArray<struct FBoneReference> BonesToPrioritize; // 0x68(0x10)
	float WeightOfPrioritization; // 0x78(0x04)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct UAnimSequence* BakePose; // 0x80(0x08)
	struct UAnimSequence* BakePoseOverride; // 0x88(0x08)
	struct FString SourceImportFilename; // 0x90(0x10)
	char bHasBeenSimplified : 1; // 0xa0(0x01)
	char bHasPerLODVertexColors : 1; // 0xa0(0x01)
	char bAllowCPUAccess : 1; // 0xa0(0x01)
	char bSupportUniformlyDistributedSampling : 1; // 0xa0(0x01)
...
struct FSkeletalMeshOptimizationSettings {
	...
	uint32 MaxNumOfTriangles; // 0x0c(0x04)
	uint32 MaxNumOfVerts; // 0x10(0x04)
	...
	int MaxBonesPerVertex; // 0x28(0x04)
...
struct FSkeletalMeshClothBuildParams {
	...
	int TargetLod; // 0x08(0x04)
	bool bRemapParameters; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	struct FString AssetName; // 0x10(0x10)
	int LODIndex; // 0x20(0x04)
	int SourceSection; // 0x24(0x04)
	bool bRemoveFromMesh; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct UPhysicsAsset* PhysicsAsset; // 0x30(0x28)
};
...
struct FSkeletonToMeshLinkup {
	struct TArray<int> SkeletonToMeshTable; // 0x00(0x10)
	struct TArray<int> MeshToSkeletonTable; // 0x10(0x10)
};
...
struct FSoundAttenuationSettings : FBaseAttenuationSettings {
	...
	enum class EAirAbsorptionMethod AbsorptionMethod; // 0xb3(0x01)
	enum class ECollisionChannel OcclusionTraceChannel; // 0xb4(0x01)
	enum class EReverbSendMethod ReverbSendMethod; // 0xb5(0x01)
	char pad_B6[0x2]; // 0xb6(0x02)
	float OmniRadius; // 0xb8(0x04)
	float StereoSpread; // 0xbc(0x04)
	float LPFRadiusMin; // 0xc0(0x04)
	float LPFRadiusMax; // 0xc4(0x04)
	...
	float LPFFrequencyAtMin; // 0x1d8(0x04)
	float LPFFrequencyAtMax; // 0x1dc(0x04)
	float HPFFrequencyAtMin; // 0x1e0(0x04)
	float HPFFrequencyAtMax; // 0x1e4(0x04)
	float FocusAzimuth; // 0x1e8(0x04)
	float NonFocusAzimuth; // 0x1ec(0x04)
	float FocusDistanceScale; // 0x1f0(0x04)
	float NonFocusDistanceScale; // 0x1f4(0x04)
	float FocusPriorityScale; // 0x1f8(0x04)
	float NonFocusPriorityScale; // 0x1fc(0x04)
	float FocusVolumeAttenuation; // 0x200(0x04)
	float NonFocusVolumeAttenuation; // 0x204(0x04)
	float FocusAttackInterpSpeed; // 0x208(0x04)
	float FocusReleaseInterpSpeed; // 0x20c(0x04)
	float OcclusionLowPassFilterFrequency; // 0x210(0x04)
	float OcclusionVolumeAttenuation; // 0x214(0x04)
	float OcclusionInterpolationTime; // 0x218(0x04)
	float ReverbWetLevelMin; // 0x21c(0x04)
	float ReverbWetLevelMax; // 0x220(0x04)
	float ReverbDistanceMin; // 0x224(0x04)
	float ReverbDistanceMax; // 0x228(0x04)
	float ManualReverbSendLevel; // 0x22c(0x04)
	struct FRuntimeFloatCurve CustomReverbSendCurve; // 0x230(0x88)
	struct FSoundAttenuationPluginSettings PluginSettings; // 0x2b8(0x30)
};
...
struct FMaterialRemapIndex {
	uint32 ImportVersionKey; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TArray<int> MaterialRemap; // 0x08(0x10)
};
...
struct FMeshSectionInfoMap {
	struct TMap<uint32, struct FMeshSectionInfo> Map; // 0x00(0x50)
};

// ScriptStruct Engine.MeshSectionInfo
// Size: 0x08 (Inherited: 0x00)
struct FMeshSectionInfo {
	int MaterialIndex; // 0x00(0x04)
...
struct FStreamingTextureBuildInfo {
	uint32 PackedRelativeBox; // 0x00(0x04)
	int TextureLevelIndex; // 0x04(0x04)
...
struct FStaticMaterialLayersParameter {
	struct FMaterialParameterInfo ParameterInfo; // 0x00(0x10)
	struct FMaterialLayersFunctions Value; // 0x10(0x40)
	bool bOverride; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
...
struct FSubsurfaceProfileStruct {
	...
	struct FLinearColor BoundaryColorBleed; // 0x24(0x10)
	float ExtinctionScale; // 0x34(0x04)
	float NormalScale; // 0x38(0x04)
	float ScatteringDistribution; // 0x3c(0x04)
	float IOR; // 0x40(0x04)
	float Roughness0; // 0x44(0x04)
	float Roughness1; // 0x48(0x04)
	float LobeMix; // 0x4c(0x04)
};
...
struct FTextureSourceBlock {
	int BlockX; // 0x00(0x04)
	int BlockY; // 0x04(0x04)
	int SizeX; // 0x08(0x04)
	int SizeY; // 0x0c(0x04)
	int NumSlices; // 0x10(0x04)
	int NumMips; // 0x14(0x04)
};
...
struct FTextureLODGroup {
	...
	int LODBias; // 0x0c(0x04)
	int LODBias_Smaller; // 0x10(0x04)
	int LODBias_Smallest; // 0x14(0x04)
	char pad_18[0x4]; // 0x18(0x04)
	int NumStreamedMips; // 0x1c(0x04)
	enum class TextureMipGenSettings MipGenSettings; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	int MinLODSize; // 0x24(0x04)
	int MaxLODSize; // 0x28(0x04)
	int MaxLODSize_Smaller; // 0x2c(0x04)
	int MaxLODSize_Smallest; // 0x30(0x04)
	int OptionalLODBias; // 0x34(0x04)
	int OptionalMaxLODSize; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
...
struct FStreamingRenderAssetPrimitiveInfo {
	...
	uint32 PackedRelativeBox; // 0x28(0x04)
...
struct FTimeline {
	...
	DelegateProperty TimelinePostUpdateFunc; // 0x50(0x10)
	DelegateProperty TimelineFinishedFunc; // 0x60(0x10)
	struct TWeakObjectPtr<struct UObject> PropertySetObject; // 0x70(0x08)
	struct FName DirectionPropertyName; // 0x78(0x08)
	char pad_80[0x10]; // 0x80(0x10)
	struct UProperty* DirectionProperty; // 0x90(0x08)
};
...
struct FTimelineLinearColorTrack {
	...
	struct UStructProperty* LinearColorProperty; // 0x28(0x08)
...
struct FTimelineFloatTrack {
	...
	struct UFloatProperty* FloatProperty; // 0x28(0x08)
	char pad_30[0x10]; // 0x30(0x10)
};
...
struct FTimelineVectorTrack {
	...
	struct UStructProperty* VectorProperty; // 0x28(0x08)
	char pad_30[0x10]; // 0x30(0x10)
};
...
struct FVirtualTextureSpacePoolConfig {
	int SizeInMegabyte; // 0x00(0x04)
	int TileSize; // 0x04(0x04)
	enum class EPixelFormat Format; // 0x08(0x01)
	char pad_9[0x3]; // 0x09(0x03)
};
...
struct FBroadphaseSettings {
	...
	uint32 MBPNumSubdivs; // 0x3c(0x04)
};
...
struct FHierarchicalSimplification {
	...
	char pad_9[0x3]; // 0x09(0x03)
	struct FMeshProxySettings ProxySetting; // 0x0c(0x94)
	struct FMeshMergingSettings MergeSetting; // 0xa0(0x8c)
	float DesiredBoundRadius; // 0x12c(0x04)
	float DesiredFillingPercentage; // 0x130(0x04)
	int MinNumberOfActorsToBuild; // 0x134(0x04)
};
...
struct FLightmassWorldInfoSettings {
	...
	int NumIndirectLightingBounces; // 0x04(0x04)
	int NumSkyLightingBounces; // 0x08(0x04)
