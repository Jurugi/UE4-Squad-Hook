...
struct FJoinabilitySettings {
	...
	int MaxPlayers; // 0x0c(0x04)
	int MaxPartySize; // 0x10(0x04)
};
...
// Size: 0x08 (Inherited: 0x00)
struct FFrameRate {
	int Numerator; // 0x00(0x04)
	int Denominator; // 0x04(0x04)
};
...
struct FTimecode {
	int Hours; // 0x00(0x04)
	int Minutes; // 0x04(0x04)
	int Seconds; // 0x08(0x04)
	int Frames; // 0x0c(0x04)
