# UE4-Squad-Hook
Example hooking Unreal Engine (version 4.23) on Squad
...
I am not fixing the brokne formatting: notes/helpful info below for those who want to find things on UE4 4.2x+ versions and just mess with it.
